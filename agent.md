# Agent Entry Point & Knowledge Base

Welcome! If you are an AI Agent assigned to work on the LAN BeamDrop project, **read this file first**. It acts as the core index for the project's knowledge system.
...
## 5. Agent Workflow Constraint: Definition of Done (DoD)
