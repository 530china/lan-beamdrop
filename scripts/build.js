...
const bundlePath = path.join(rootDir, 'lan-beamdrop.js');
...
try {
  ...
  execSync('npx pkg lan-beamdrop.js -c lan-beamdrop.json -C GZip -t node18-win-x64,node18-mac-x64,node18-linux-x64 --out-path dist', { 
    stdio: 'inherit',
    cwd: rootDir
  });
  ...
  if (fs.existsSync(bundlePath)) {
    ...
    console.log('  - 已删除 lan-beamdrop.js');
  }
